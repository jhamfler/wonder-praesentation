...
\begin{frame}
	\frametitle{Teillösung 1}
	\includegraphics[scale=0.365,centered]{pictures/close_bye_bh_ba} %funzt
\end{frame}
...
\begin{frame}
	\frametitle{Teillösung 2}
	\includegraphics[scale=0.365,centered]{pictures/bye_ah_ba} %schlägt fehl
\end{frame}
